...
RSpec.describe "User index page", type: :feature do 
    let!(:user1) {User.create(name: "Tom", bio: "Engineer", photo: "photo1.jpg", posts_counter: 4)}
    let!(:user2) {User.create(name: "Joe", bio: "Developer", photo: "photo2.jpg", posts_counter: 10)}
